package com.rat.regresapitest.presentation.ui.global.adapters;
...
import com.rat.regresapitest.presentation.ui.global.views.badgedimageview.BadgedImageView;


public class ShotsAdapter extends LoadMoreAdapter<UserData> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ShotViewHolder) {
            ...
            UserData shot = getItem(position);
            Glide.with(context)
                    .load(shot.getAvatar())
